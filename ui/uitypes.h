...
// typedef BinaryNinja::Ref<BinaryNinja::ExtensionVersion> ExtensionVersionRef;
typedef BinaryNinja::Ref<BinaryNinja::Extension> ExtensionRef;
typedef BinaryNinja::Ref<BinaryNinja::ExtensionChannel> ExtensionChannelRef;
typedef BinaryNinja::Ref<BinaryNinja::ExtensionManager> ExtensionManagerRef;
